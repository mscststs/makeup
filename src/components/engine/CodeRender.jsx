 ...
 */
export default function CodeRender({ code, fallback = <div>加载中...</div>, errorFallback = DefaultErrorFallback, args = {} }) {
  ...
  const LazyComp = useMemo(() => {
    ...
    return React.lazy(() => import(/* @vite-ignore */ urlRef.current).then((mod) => ({ default: mod.default || mod })) )
  }, [moduleKey])
